...
var QueryManager = (function () {
    ...
    QueryManager.prototype.stop = function () {
        ...
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? new invariant.InvariantError(15) : new invariant.InvariantError('QueryManager stopped while query was in flight'));
    };
    ...
    QueryManager.prototype.query = function (options) {
        var _this = this;
        process.env.NODE_ENV === "production" ? invariant.invariant(options.query, 18) : invariant.invariant(options.query, 'query option is required. You must specify your GraphQL document ' +
            'in the query option.');
        process.env.NODE_ENV === "production" ? invariant.invariant(options.query.kind === 'Document', 19) : invariant.invariant(options.query.kind === 'Document', 'You must wrap the query string in a "gql" tag.');
        process.env.NODE_ENV === "production" ? invariant.invariant(!options.returnPartialData, 20) : invariant.invariant(!options.returnPartialData, 'returnPartialData option only supported on watchQuery.');
        process.env.NODE_ENV === "production" ? invariant.invariant(!options.pollInterval, 21) : invariant.invariant(!options.pollInterval, 'pollInterval option only supported on watchQuery.');
    ...
    QueryManager.prototype.clearStore = function () {
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? new invariant.InvariantError(22) : new invariant.InvariantError('Store reset while query was in flight (not completed in link chain)'));
...
function computeKeyObject(response, specifier, aliasMap) {
    ...
    specifier.forEach(function (s) {
        if (Array.isArray(s)) {
            ...
            process.env.NODE_ENV === "production" ? invariant.invariant(hasOwn$1.call(response, responseName), 36) : invariant.invariant(hasOwn$1.call(response, responseName), "Missing field '" + responseName + "' while computing key fields");
